...
function hashCode(str){ // Генерирует интовое хеш-значение на основе строки.
...
function Components(com){
    switch(typeof com){
        //..................................
        // Регистрация функции или класса в качестве компонента
        case "function":
...
/*/////////////////////////////////////////////////////////////////////////////////
	Entities
	Basically just a container for a list of Components
...
class Assemblages{
    static async add(name, comList){
        //..............................
        //Dynamically Load in components that are not registered.
...
class Ecs{
    ...
    addSystem(system, priority = 50){
        ...
        if(saveIdx === -1) this.Systems.push(itm);
            ...
            for(let x = this.Systems.length-1; x > saveIdx; x--){	//Shift the array contents one index up
